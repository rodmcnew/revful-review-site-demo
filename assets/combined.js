            ...
            element[0].addEventListener("keydown", function (e) {
                ...
                switch (keycode) {
                    ...
                    case key.right:
                        break;
                    case key.enter:
                        //ADDED for revful for better enter support
                        if (scope.getIndex()==-1) {
                            scope.setIndex(0);
                            scope.preSelect(angular.element(angular.element(this).find('li')[index]).text());
                            scope.$apply();
...
var module = angular.module('app', ['ngRoute','autocomplete']);

module.controller('Home', function ($http) {
    var self = this;
    this.suggestions = [];
    self.selected = '';
